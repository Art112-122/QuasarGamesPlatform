<template>
  <div class="q-pa-md row fullscreen">
    ...
    >
      <h3 :style="$q.screen.width >= 500 ? '' : 'font-size: 2rem'">Вхід</h3>
      ...
      <q-btn label="Увійти" type="submit" color="primary" style="margin-left: 3rem" />

      <div class="text-center subtitle" style="margin-top: 2rem">
        <router-link class="text-primary" to="/register">Створити Аккаунт</router-link>
      </div>
    </q-form>
    <div
      ref="image"
